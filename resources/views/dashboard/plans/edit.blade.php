...
<div class="row">
    <div class="col-xl-8 col-md-5 mx-4 ">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/dashboard/plans/{{ $plan->id }}">
                    @method('put')
                    @csrf
                    <div class="form-group">
                      <label for="name">Nama</label>
                      <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama Plan" value="{{ old('name', $plan->name) }}">
                      @error('name')
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <input id="desc" type="hidden" name="desc" value="{{ old('desc', $plan->desc)  }}">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="Number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Harga Rencana Belajar" value="{{ old('desc', $plan->price) }}">
                    </div>
                    @error('price')
                        <div class="invalid-feedback">
                        {{ $message }}
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="custom-select  @error('durationMany') is-invalid @enderror" id="durationMany" name="durationMany">
                                    @for ($i = 1; $i <= 31; $i++)
                                    @if(old('durationInform', $durationMany) == $i)
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select  @error('durationInform') is-invalid @enderror" id="duration" name="durationInform">
                                    @if(old('durationInform', $durationInform) == "day")
                                    <option value="day" selected>Hari</option>
                                    <option value="month">Bulan</option>
                                    <option value="year">Tahun</option>

                                    @elseif(old('durationInform', $durationInform) == "month")
                                    <option value="month" selected>Bulan</option>
                                    <option value="day">Hari</option>
                                    <option value="year">Tahun</option>

                                    @elseif(old('durationInform', $durationInform) == "year")
