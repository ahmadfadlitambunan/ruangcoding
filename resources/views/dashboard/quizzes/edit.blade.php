...
<div class="row">
    <div class="col-xl-8 col-md-5 mx-4 ">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/dashboard/quizzes/{{ $quiz->id }}">
                    @method('put')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <input type="hidden" id="question" name="question" value="{{ old('question', $quiz->question)  }}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xl-3">
                                <select class="form-select @error('access_type') is-invalid @enderror" id="access_type" name="access_type" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="form-group">                        
                                <input type="text" class="form-control @error('option1') is-invalid @enderror" id="option1" name="option1" placeholder="Opsi pertama" value="{{ old('option1', $quiz->option1)  }}">
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="form-group">                        
                                <input type="text" class="form-control @error('option2') is-invalid @enderror" id="option1" name="option2" placeholder="Opsi pertama" value="{{ old('option2', $quiz->option2)  }}">
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="form-group">                        
                                <input type="text" class="form-control @error('option3') is-invalid @enderror" id="option1" name="option3" placeholder="Opsi pertama" value="{{ old('option3', $quiz->option3)  }}">
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="form-group">                        
                                <input type="text" class="form-control @error('option4') is-invalid @enderror" id="option1" name="option4" placeholder="Opsi pertama" value="{{ old('option4', $quiz->option4)  }}">
                            </div>
                        </div>
