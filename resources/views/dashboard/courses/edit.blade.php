            ...
            <div class="card-body">
                <form method="POST" action="/dashboard/courses/{{ $course->id }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama Kelas" value="{{ old('name', $course->name) }}">
                      @error('name')
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <input id="desc" type="hidden" name="desc" value="{{ old('desc', $course->desc)  }}">
                    ...
                    <div class="form-group">
                        ...
                        @if($course->image)
                            <img src="{{ asset('storage/' . $course->image) }}" class="img-preview img-fluid mb-3 col-sm-4 d-block">
                        @else
